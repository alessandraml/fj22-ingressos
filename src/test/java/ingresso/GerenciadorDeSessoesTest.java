...
public class GerenciadorDeSessoesTest {
	...
	@Test
	public void garanteQueNaoDevoPermitirSessaoNoMesmoHorario(){
	...
	@Test
	public void garanteQueNaoDevoPermitirSessoesTerminandoDentroDeUmaSessaoJaExistente(){
		Filme filme = new Filme("Rogue One", Duration.ofMinutes(120), "SCI-FI", BigDecimal.ONE);
		LocalTime horario = LocalTime.now();
	...
	@Test
	public void garanteQueNaoDevoPermitirSessoesIniciandoDentroDeUmaSessaoJaExistente(){
		Filme filme = new Filme("Rogue One", Duration.ofMinutes(120), "SCI-FI", BigDecimal.ONE);
		LocalTime horario = LocalTime.now();
